				...
				<View className="flex-row space-x-3">
					{activeParticipants.map((participant) => (
						<View key={participant.userId} className="items-center">
							<View
								className={`w-10 h-10 rounded-full ${getAvatarColor(participant.userId)} items-center justify-center mb-1`}
							>
							...
							<Text
								className="text-xs text-gray-600 dark:text-gray-400 max-w-16 text-center"
								numberOfLines={1}
							>
